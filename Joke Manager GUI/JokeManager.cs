...
namespace JokeManagerNamespace
{
    public class JokeManager
    {
        public static int SaveJoke(String UCID, String joke)
        {
            ...
            SqlParameter ucidParam = new SqlParameter("@ucid", System.Data.SqlDbType.NChar, 8);
            ucidParam.Value = UCID;

            SqlParameter jokeParam = new SqlParameter("@joke", System.Data.SqlDbType.NVarChar);
            jokeParam.Value = joke;

            parameters.Add(ucidParam);
            parameters.Add(jokeParam);
